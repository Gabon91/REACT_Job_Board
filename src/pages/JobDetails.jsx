  ...
  if (notFound) {
    return (
      <div className="container py-5 text-center">
        ...
        <p className="text-muted"> The job you are looking for does not exist or was removed.</p>
      ...
      <div className="card shadow-sm">
        ...
        <div className="card-body p-4">
          <div className="d-flex flex-column flex-md-row justify-content-between gap-3 mb-4">
            <div>
              <h1 className="text-capitalize mb-2"> {job.title} </h1>
              <h4 className="text-muted text-capitalize"> {job.company} </h4>
            </div>

            <div>
              <span className="badge bg-primary fs-6 text-capitalize"> {job.category} </span>
            </div>
          </div>
          <hr/>
          ...
          <div className="row g-4 my-2">
            <div className="col-12 col-md-6">
              ...
              <p>
                ...
                <span className="text-capitalize"> {job.experienceLevel} </span>
              </p>
          ...
          {job.applyLink && (
            <>
              ...
              <div className="text-center mt-4">
                <a href={job.applyLink} target="_blank" rel="noopener noreferrer" className="btn btn-success btn-lg"> Apply for this Job </a>
              </div>
            </>
          )}
        </div>
